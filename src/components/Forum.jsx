...
const ForumPicker = (props) =>{
    ...
    ?"text-center text-5xl  font-mono_r text-neutral-600 font-times_n"
    :"text-center text-5xl font-mono_r text-neutral-200 font-times_n"

    const iconStyling = theme ==="light"
    ?"text-center text-[6rem] text-neutral-600 font-times_n"
    :"text-center text-[6rem] text-neutral-200 font-times_n"



    return(
    <div className=" p-12 m-0 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full flex flex-col items-center align-middle justify-center">
        <h1 className={h1Styling}>
        Chose your world
        </h1>

        <div className="grid grid-flow-col py-6 gap-10 border-b border-b-neutral-200  place-items-center items-center justify-center align-middle w-fit h-60">
